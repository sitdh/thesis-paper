...
\documentclass[journal,onecolumn]{IAENGtran}
%
...
\author{Sitdhibong~Laokok,~\IAENGmembership{Member,~IAENG,}
        and~Assc.Prof.~Dr.~ Taratip Suwannasart,~\IAENGmembership{Senior Member,~IAENG,}}%
...
% \begin{figure}[!t]
% \centering
% \includegraphics[width=2.5in]{figures/NEURAL_NETWORK}
